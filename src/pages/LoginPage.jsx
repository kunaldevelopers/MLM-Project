  ...
  const getDemoUserIcon = (role) => {
    switch (role) {
      ...
      case "moderator":
        return Settings;
      case "user":
        return demoUsers.find((u) => u.role === role && u.totalEarnings > 10000)
          ? Crown
          : User;
      default:
        return User;
          ...
          <div className="max-w-lg">
            ...
            <div className="flex items-center space-x-4 mb-12">
              <div className="relative">
                ...
                />
                <div
                  className="h-16 w-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl"
                  style={{ display: "none" }}
                >
            ...
            <div className="mb-12">
              ...
              <p className="text-lg text-blue-100 leading-relaxed">
                ...
                financial freedom through our innovative MLM platform.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-200">
                    Track your earnings and team performance instantly
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-200">
                    Unlock ranks and bonuses as you grow
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-200">
                    Advanced features for serious entrepreneurs
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-8">
              <div className="flex justify-center items-center space-x-3 mb-4">
                ...
                />
                <div
                  className="h-12 w-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center"
                  style={{ display: "none" }}
                >
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <span className="ml-2 text-sm text-blue-100 font-medium">
                      Remember me
                    </span>
                  </label>
                  <Link
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-2">
                              ...
                              <span
                                className={`px-2 py-1 rounded-md text-xs font-bold ${getRoleColor(
                                  demoUser.role
                                )}`}
                              >
                                {demoUser.role}
